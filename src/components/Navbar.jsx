...
const Navbar = () => {
    return (
    <>
        <nav className="navbar navbar-expand-sm navbar-info bg-dark py-2 fixed-top">
            <div className="container-fluid ">
                <span className="navbar-brand font-weight-bolder">Ahsan's Hotel</span>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" activeClassName="active_class" exact to="/user">LogIn/SignUp</NavLink>
                        </li>
                    </ul>
                </div>
            </div>
